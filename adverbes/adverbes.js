...
const adverbes = [
  ...
  { arabe: 'مَعَ', francais: ['avec', 'avec '] },
  { arabe: 'عِنْدَ', francais: ['à', 'à '] },
  { arabe: 'وَسَطَ', francais: ['au milieu de', 'au milieu', 'au milieu de ', 'au milieu '] },
  { arabe: 'عَبْرَ', francais: ['à travers', 'a travers'] },
  { arabe: 'بَيْنَ', francais: ['entre', 'entre '] },
  { arabe: 'حَوْلَ', francais: ['autour de', 'autour'] },
  { arabe: 'لَدَى', francais: ['à', 'à '] },
  { arabe: 'لَدُنْ', francais: ['de', 'de '] },
  { arabe: 'حَيْثُ', francais: ['où','où ', 'ou ', 'ou'] },
  { arabe: 'أَيْنَ', francais: ['où','où ', 'ou ', 'ou'] },
  { arabe: 'هُنا', francais: ['ici', 'ici '] },
  { arabe: 'هُناك', francais: ['là-bas', 'la bas', 'là bas', 'là bas ', 'là-bas '] },
  { arabe: 'ثُمَّ', francais: ['puis', 'puis '] },
  { arabe: 'قَبْلَ', francais: ['avant', 'avant '] },
  { arabe: 'بَعْدَ', francais: ['après', 'après ', 'apres', 'apres '] },
  { arabe: 'بَيْنَما', francais: ['alors que', 'alors que '] },
  { arabe: 'خِلالَ', francais: ['pendant', 'pendant '] },
  { arabe: 'مُنْذُ', francais: ['depuis', 'depuis '] },
  { arabe: 'عِنْدَما', francais: ['lorsque', 'lorsque '] },
  { arabe: 'إِلى أنْ', francais: ['jusqu\'à ce que', 'jusqu\'à ce que ', 'jusqu à ce que', 'jusqu à ce que', 'jusqu a ce que', 'jusqu a ce que '] },
  { arabe: 'مَتى', francais: ['quand', 'quand '] },
  { arabe: 'طالَما', francais: ['tant que', 'tant que '] },
  { arabe: 'إِذْ', francais: ['quand', 'quand '] },
  { arabe: 'إِذًا', francais: ['alors', 'alors '] },
  { arabe: 'إِذَنْ', francais: ['alors', 'alors '] },
  { arabe: 'الآن', francais: ['maintenant', 'maintenant '] },
  { arabe: 'اليَوْم', francais: ['aujourd\'hui', 'aujourdhui', 'aujourd hui', 'aujourdhui ', 'aujourd hui '] }
];
